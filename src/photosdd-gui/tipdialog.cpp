...
void TipDialog::loadTips(){
    tips.append(QString("Functions of this program are organized in plugins.<br/>"
                        "You have to config and activate plugins first, to use them."));
    tips.append(QString("Activated plugins can be configured through their widget."));
}
...
void TipDialog::loadConfig(){
    ...
    qDebug("[TipDialog] settings path: %s / %s", qPrintable(QCoreApplication::organizationName()),

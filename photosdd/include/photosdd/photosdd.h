...
#include "photosdd/photosdd_global.h"
#include "photosdd/pluginsdialog.h"
#include "photosdd/photosddplugin.h"

class PHOTOSDDSHARED_EXPORT PhotosDD: public QObject {
Q_OBJECT
private:
...
public:
	...
	static QString applicationName() {
		return QString("PhotosDD");
	}
	static QString applicationDomain() {
		return QString("http://photosdd.sourceforge.net/");
	}
	static QString applicationVersion() {
		return QString("0.2");
	}
	static QIcon applicationIcon() {
		return QIcon(":/icon/photosdd");
	}
